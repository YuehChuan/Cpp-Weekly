...
class beta::test_container : public beta::noncopyable {
...
void beta::test_container::run_all() {
...
void beta::test_container::test_resize() {
...
void beta::test_container::test_emplace_back() {
  std::random_device device;
  std::mt19937 generator(device());
...
void beta::test_container::test_status(const char* const signature, bool bool_expression) {
  if (bool_expression) {
